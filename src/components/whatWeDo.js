    ...
    <div >
        ...
        <div className={features}>
            ...
            <section className={featuresSection}>
                ...
                <h3 ref={c}>{topLeftTitle}</h3>
                </span>
                <p className={featuresText}>{topLeftDesc}</p>
            </section>
            <section className={featuresSection}>
                <span className={icon}>
                <span className={iconHolder}>
                ...
                <p className={featuresText}>{topRightDesc}</p>
            </section>
            </div>
            ...
            <section className={featuresSection}>
                ...
                <h3>{bottomLeftTitle}</h3>
                </span>
                <p className={featuresText}>{bottomLeftDesc}</p>
            </section>
            <section className={featuresSection}>
            <span className={icon}>
                <span className={iconHolder}>
                ...
                <h3>{bottomRightTitle}</h3>
                </span>
                <p className={featuresText}>{bottomRightDesc}</p>
            </section>
            </div>
        </div>
